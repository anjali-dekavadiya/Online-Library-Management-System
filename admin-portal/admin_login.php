...
<!--
        ...
        <section>
            ...
            <br><br><br>
              <div class="box1">
                  <h1 style="text-align: center; font-size: 35px; font-family: lucida Console;">Library Managment System </h1><br>
                  ...
                  <form name="login" action="" method="post">
                    ...
                    <div class="login">
                      ...
                      <input class="btn btn-default" type="submit" name="submit" value="Login" style="color: white; width:310px;height: 30px;background-color: green">
                    </div>

                  
                  <p style="color:white; padding-left: 15px;">
                      <br><br>
                      <a style="color: yellow;" href="update_password.php">Forgot password?</a> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 
