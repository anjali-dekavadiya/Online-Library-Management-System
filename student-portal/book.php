...
<html>
    ...
    <!--_________________________________search bar___________________________________-->
    ...
    <!--_____________________request book_________________________________________________-->
    <div class="srch">
        <form class="navbar-form" method="post" name="form1">
